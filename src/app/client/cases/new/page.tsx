...
function NewCaseContent() {
  ...
  const [consultationRoute, setConsultationRoute] = useState<UiConsultationRoute | undefined>();
  ...
  const searchData = useMemo<SearchPrefill | null>(() => {
    ...
    const logoHasText =
      ...
      LOGO_TEXT_OPTIONS.includes(logoParam as (typeof LOGO_TEXT_OPTIONS)[number])
        ? (logoParam as "あり" | "なし")
        : undefined;
